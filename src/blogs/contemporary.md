...
Only in the third week did we get access to BCI caps, and they were different to the ones we were shown in previous classes. These FlexEEG caps from NeuroCONCISE (a company founded by UU Magee staff) were much simpler and had only seven electrodes, with six designed to read the primary motor cortex, and the last reading baseline activity from the premotor cortex. This meant more complicated tasks like estimating emotional states were not possible, but I believed our group would still be able to continue with our idea. 
